...
/**
 * Razred koji simulira povećanje vrijednosti unutar registra za 1.
 * 
 * @author Jure Šiljeg
 * @version 1.0
 */
public class InstrIncrement implements Instruction {
	/** Indeks registra nad kojim se vrši inkrementiranje. */
	private int registerIndex;

	/**
	 * Konstruktor za komandu inkrementiranja. Pronalazi indeks registra nad
	 * kojim obavljamo operaciju.
	 * 
	 * @param arguments
	 *            argumenti uz komandu inccrement.
	 */
