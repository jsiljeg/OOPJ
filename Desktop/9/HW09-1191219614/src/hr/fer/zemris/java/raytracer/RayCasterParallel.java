...
/**
 * Razred za simulaciju paraleliziranog renderiranja scene s objektima i
 * izvorima svjetlosti.
 * 
 * @author Jure Šiljeg
 * @version 1.0
...
public class RayCasterParallel {
	...
	/** Minimalni broj piksela u rekurziji koji će se prikazati. */
	...
	private static IRayTracerProducer getIRayTracerProducer() {
		...
		return new IRayTracerProducer() {
			...
			public void produce(Point3D eye, Point3D view, Point3D viewUp, double horizontal, double vertical,
				...
				PosaoIzracuna job = new PosaoIzracuna(0, height, width, height, xAxis, yAxis, zAxis, eye, view,
						horizontal, vertical, scene, screenCorner, red, green, blue);
				...
				System.out.println("Vrijeme u paraleliziranom načinu rada: " + estimatedTime + "ms");
			}
			 ...
			 * @version 1.0
			 */
			class PosaoIzracuna extends RecursiveAction {
				/** Defaultni ID verzije serije. */
				private static final long serialVersionUID = -6946558354958100164L;
				...
				/** Smjer koji označava "prostiranje" x-osi. */
				Point3D xAxis;
				/** Smjer koji označava "prostiranje" y-osi. */
				Point3D yAxis;
				/** Smjer koji označava "prostiranje" z-osi. */
				Point3D zAxis;
				/** Točka očišta. */
				Point3D eye;
				/** Točka gledišta. */
				...
				/** Scena na kojoj se sve odvija. */
				Scene scene;
				/** Početni ugao panela. */
				Point3D screenCorner;

				/** Intezitet crvenog svjetla u pikselu. */
				short[] red;
				/** Intezitet crvenog zelenog u pikselu. */
				short[] green;
				/** Intezitet crvenog plavog u pikselu. */
				short[] blue;

				/**
				 * Konstruktor za inicijalizaciju svih vrijednosti.
				 * 
				 * @param yMin
				 *            Minimalna vrijednost kad se ide po y-osi
				 * @param yMax
				 ...
				 *            Intezitet crvenog svjetla u pikselu.
				 * @param green
				 *            Intezitet zelenog svjetla u pikselu.
				 * @param blue
				 *            Intezitet plavog svjetla u pikselu.
				 */
				public PosaoIzracuna(int yMin, int yMax, int width, int height, Point3D xAxis, Point3D yAxis,
						Point3D zAxis, Point3D eye, Point3D view, double horizontal, double vertical, Scene scene,
						Point3D screenCorner, short[] red, short[] green, short[] blue) {
					super();
					this.yMin = yMin;
					this.yMax = yMax;
					this.width = width;
				...
				protected void compute() {
					if (yMax - yMin <= THRESHOLD) {
						...
						int endOfFirstQuarter = yMin + (yMax - yMin) / 4;
						int endOfSecondQuarter = yMin + (yMax - yMin) / 2;
						int endOfThirdWuarter = yMax - (yMax - yMin) / 4;
						invokeAll(
								new PosaoIzracuna(yMin, endOfFirstQuarter, width, height, xAxis, yAxis, zAxis, eye,
										view, horizontal, vertical, scene, screenCorner, red, green, blue),
								new PosaoIzracuna(endOfFirstQuarter, endOfSecondQuarter, width, height, xAxis, yAxis,
										zAxis, eye, view, horizontal, vertical, scene, screenCorner, red, green, blue),
								new PosaoIzracuna(endOfSecondQuarter, endOfThirdWuarter, width, height, xAxis, yAxis,
										zAxis, eye, view, horizontal, vertical, scene, screenCorner, red, green, blue),
								new PosaoIzracuna(endOfThirdWuarter, yMax, width, height, xAxis, yAxis, zAxis, eye,
										view, horizontal, vertical, scene, screenCorner, red, green, blue)
				...
				/**
				 * U slučaju da smo "dovoljno nisko u rekurziji", treba odraditi
				 * automatsko računanje bez daljnjeg dijeljena na poslove.
				 */
				 ...
				 *            Zraka.
				 * @param rgb
				 *            Polje koje sadrži intezitete tonova boja. Njega
				 *            ćemo napuniti i vratiti.
				...
				/**
				 * Metoda pronalazi najbliže presjecište zrake koja ide iz
				 * očišta i predmeta na sceni.
				 * 
				 * @param objects
				 *            Predmeti na sceni.
				 * @param ray
				...
				/**
				 * Metoda koja određuje boju piksela ako objekt nije sakriven.
				 * To radimo po sljedećem algoritmu:
				 * 
				 * <pre>
				...
				private short[] determineColor(RayIntersection closestIntersection, Scene scene, Ray ray, short[] rgb) {
					...
					for (LightSource ls : lights) {
						...
						if (closestIntersectionWithLightSource != null
							...
							Point3D reflected = normal.scalarMultiply(toLight.scalarProduct(normal) * 2)
									.modifySub(toLight).normalize();
				...
				/**
				 * Metoda računa kosinus kuta između normale na presjecište i
				 * zrake koja ide prema izvoru svjetla.
				 * 
				 * @param normal
